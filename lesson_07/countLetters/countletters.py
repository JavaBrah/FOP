...
#  but only the letters should be counted. 
# The string could even be the empty string 
# (just ""). Lower-case and upper-case versions of a letter should be 
# part of the same count. The keys of the dictionary should be upper-case letters.
#  If a letter does not appear in the string, 
